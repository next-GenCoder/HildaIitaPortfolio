...
# --- THEME DESIGN SYSTEM (Coral Nebula) ---
BG = '#1E1E24'
SURFACE = '#2D2D37'
TEXT = '#F7F7F9'
MUTED = '#A9A9B3'
...
def main(page: ft.Page):
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Row([
                        ...
                        ft.Text("22093072@students.unam.na", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/next-GenCoder", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['.github/workflows/project-checks.yml', 'docs/Testing_Checklist.md', 'scripts/project-check.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Project checks, CI, and testing documentation.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Hilda Iita"\ngit config user.email "22093072@students.unam.na"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Hilda Iita | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
